...
class Product(models.Model):
    ...
    is_digital = models.BooleanField(default=False, help_text="Whether this is a digital product (no shipping required)")
    weight = models.DecimalField(max_digits=6, decimal_places=2, default=0, help_text="Weight in kilograms")
    requires_special_shipping = models.BooleanField(default=False, help_text="Whether this product requires special shipping handling")
    meta_keywords = models.CharField(max_length=255, blank=True, null=True)
